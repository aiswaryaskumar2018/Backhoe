...
/* USER CODE BEGIN EV */
volatile uint8_t ignoreEccErr = 0;
volatile uint8_t eccDoubleBitErrOccurred = 0;
/* USER CODE END EV */
...
/* USER CODE BEGIN 1 */
uint8_t GetNMI_HandllerStatus(void)
{
	return eccDoubleBitErrOccurred;
}
/* USER CODE END 1 */
